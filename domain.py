...
class DiscreteRoverDomain:
    def __init__(self, p):
        ...
        self.agents = None
        self.gen_agents()                 # generate agents
    ...
    def gen_agents(self):
        ...
        self.agents = [Agent(x, y, idx, np.random.random(self.n_pois), np.random.randint(0, self.n_agent_types), self.p)
